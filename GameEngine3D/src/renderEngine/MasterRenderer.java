...
//	private GuiShader guiShader = new GuiShader();
	...
	public static void setSkyRed(float skyRed) {
		MasterRenderer.skyRed = skyRed;
	}
	...
	public static void setSkyGreen(float skyGreen) {
		MasterRenderer.skyGreen = skyGreen;
	}
	...
	public static void setSkyBlue(float skyBlue) {
		MasterRenderer.skyBlue = skyBlue;
	}
